...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { is_available: @table.is_available, seat_number: @table.seat_number, table_name: @table.table_name } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { is_available: @table.is_available, seat_number: @table.seat_number, table_name: @table.table_name } }
